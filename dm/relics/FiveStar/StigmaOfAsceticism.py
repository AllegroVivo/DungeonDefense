...
__all__ = ("StigmaOfAsceticism",)

################################################################################
class StigmaOfAsceticism(DMRelic):
    ...
    def __init__(self, state: DMGame):
        ...
        super().__init__(
            state,
            _id="REL-318",
            name="Stigma of Asceticism",
            description="Dark Lord's LIFE, ATK, and DEF decrease by 50 %.",
            rank=5,
...
################################################################################
    def advance_relic(self) -> None:
        ...
        self.game.add_relic("First Mark of Asceticism")
        # Remove this relic
